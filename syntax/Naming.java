package syntax;
// 자바에는 이름짓는 규칙 (Naming Convention)
// 공통규칙
// 1. 자바는 50여가지의 에약어(keyword)가 있고
//    자바가 내부적으로 지정한 프로그래밍적 기능이 있기 때문에
//    해당 예약어로는 우리가 이름을 지어줄 수 없다.
//    그러므로 50여가지를 여러분들이 외우셔야 합니다. -> 옛날 옛적 이야기
...
//    즉 Member와 member는 스펠링이 같아도 대소문자가 다르기 때문에
//    다른 존재가 된다!!!!
...
// 클래시 이름 규칙
// 1. 클래스는 낙타등 표기법을 사용하고 대문자를 시작하는 명사이다.
