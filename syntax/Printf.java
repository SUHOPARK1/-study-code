...
public class Printf {
    public static void main(String[] args) {
        ...
        //C. 16진법 정수를  오른쪽 정렬 5자리로 출력하고, 알파벳이 있으면 소문자로 표시해라
        System.out.printf("C. %5x\n", number);        
        
        //D. 16진법 정수를 오른쪽 정렬 5자리로 출력하고, 알파벳이 있으면 대문자로 표시해라        
        System.out.printf("D. %5X\n", number);
        
        //E. 16진법 정수를 왼쪽 정렬 5자리를 표시하고, 알파벳이 있으면 소문자로 표시해라
        System.out.printf("E. %-5x(끝)\n", number);  
        
        //F. 16진법 정수를 왼쪽 정렬 5자리로 출력하고, 알파벳이 있으면 대문자로 표시해라
        System.out.printf("F. %-5X(끝)\n", number);  
        
        //G. 16진법 정수를 오른쪽 정렬 5자리로 표시하고, 왼쪽 빈 자리에는 0으로 채우고 알파벳이 있으면
        //   대문자로 채워라
