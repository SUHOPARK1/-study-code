...
//총점 ###점 평균: ##.##점
//의 형식으로 출력하는 프로그램을 작성하세요.
//단, 국영수 점수 같은 경우에는 사용자가 잘못된 점수를 입력하면
//올바른 점수가 들어올때까지 다시 입력을 받게 하시오
//또한 처음 프로그램을 시작할때
// 사용자가 입력, 출력, 종료를 선택하여
// 사용자가 원하는 횟수만큼 입력하고 출력할 수 있게 프로그램을 작성하시오
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (userChoice == 1) {
                ...
                // 만약 국어점수가 -1이면
                // 아직 아무 정보도 입력되지 않은 상태이므로
                // 경고메세지만 출력하고
                // 그외에는 정상적으로 정보 출력하도록 한다.
                if (korean == -1) {
                    // 아무런 정보도 입력되지 않은 상태이므로
                    // 메시지만 출력
                    System.out.println("아직 아무런 정보로 입력되지 않았습니다.");
                } else {
                    // 정보가 입력된 상태이므로 정보 출력하는 코드실행
